...
async def handle_unexpected_materials_input(message: Message, state: FSMContext):
    ...
    if message.photo:
        await message.answer(
            ...
            "Пожалуйста, отправьте документ, изображение или текст.",
            parse_mode="HTML"
        )
...
async def handle_unexpected_test_name_input(message: Message, state: FSMContext):
    ...
    if not message.text or len(message.text.strip()) < 3:
        await message.answer(
            ...
            "Пожалуйста, введите осмысленное название для твоего теста.\n\n"
        ...
        await message.answer(
            "🔄 <b>Повторите ввод</b>\n\n"
            "Пожалуйста, введите название для твоего теста:",
            parse_mode="HTML"
        )
